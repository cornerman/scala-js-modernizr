...
object Projects {
  val projectId = "scala-js-modernizr"
  val projectName = "scala-js-modernizr"
  ...
  private[this] val scalaJsSettings = Seq(
    ...
    homepage := Some(url("https://github.com/DefinitelyScala/scala-js-modernizr")),
    scmInfo := Some(ScmInfo(
      url("https://github.com/DefinitelyScala/scala-js-modernizr"),
      "scm:git:git@github.com:DefinitelyScala/scala-js-modernizr.git",
      Some("scm:git:git@github.com:DefinitelyScala/scala-js-modernizr.git")
    )),
    bintrayOrganization := Some("definitelyscala"),
    bintrayPackageLabels := Seq("scala", "scala.js"),
    bintrayPackage := "scala-js-modernizr",
    bintrayRepository := "maven",
    bintrayVcsUrl := Some("git:git@github.com:DefinitelyScala/scala-js-modernizr.git"),
  ...
  lazy val modernizr: Project = Project(id = projectId, base = file(".")).settings(commonSettings ++ scalaJsSettings).enablePlugins(ScalaJSPlugin)
}
